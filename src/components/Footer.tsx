      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-8 md:px-16 lg:px-24 xl:px-32">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 animate-fade-in-up">
            <div className="text-xs font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent" style={{fontFamily: 'Copperplate Gothic Bold, serif'}}>
              Cheshta Agarwal
            </div>
