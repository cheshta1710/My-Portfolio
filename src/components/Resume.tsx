    ...
    <section id="resume" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 md:px-8">
        <div className="max-w-4xl text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-8 text-white text-center" style={{fontFamily: 'Copperplate Gothic Bold, serif', textShadow: '0 0 20px rgba(59, 130, 246, 0.8), 0 0 40px rgba(59, 130, 246, 0.4), 0 0 60px rgba(59, 130, 246, 0.2)'}}>DOWNLOAD RESUME</h2>
