...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black py-14">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-10 animate-fade-in-up">
            ...
            <div className="space-y-5">
              <h1 className="text-4xl md:text-6xl font-bold text-white glow-border p-10 rounded-lg" style={{fontFamily: 'Copperplate Gothic Bold, serif'}}>
                CHESHTA AGARWAL
              </h1>
            ...
            {/* Social Links */}
            <div className="flex justify-center space-x-8 pt-10 animate-fade-in-up animation-delay-1500">
              <a
