...
const TechBlogs: React.FC = () => (
  <section id="tech-blogs" className="py-20 bg-black relative overflow-hidden">
    ...
    <div className="relative z-10 w-full max-w-6xl mx-auto px-8">
      <h2 className="text-4xl md:text-5xl font-bold text-center mb-10 md:mb-16 text-white" style={{fontFamily: 'Copperplate Gothic Bold, serif', textShadow: '0 0 20px rgba(59, 130, 246, 0.8), 0 0 40px rgba(59, 130, 246, 0.4), 0 0 60px rgba(59, 130, 246, 0.2)'}}>
        TECH BLOGS
      </h2>
