  ...
  <section id="tech-blogs" className="py-20 bg-black relative overflow-hidden">
    ...
    <div className="relative z-10 w-full max-w-6xl mx-auto px-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
        {/* Blog 1 */}
        <div className="flex-1 bg-black/60 border border-blue-500/20 rounded-2xl p-8 flex flex-col justify-between shadow-lg hover:shadow-blue-500/30 transition-all duration-300 animate-fade-in-up">
          <h3 className="text-xl font-semibold text-white mb-6" style={{fontFamily: 'Copperplate Gothic Bold, serif'}}>Why Big Companies Are Switching to Linux (And Why You Should Care)</h3>
          <a href="https://medium.com/@cheshtaagarwal17/why-big-companies-are-switching-to-linux-and-why-you-should-care-1cff8e9bf291" target="_blank" rel="noopener noreferrer" className="mt-auto flex items-center justify-between bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-lg font-semibold shadow hover:from-blue-600 hover:to-blue-400 transition-all duration-300 group" data-cursor-hover>
        ...
        {/* Blog 2 */}
        <div className="flex-1 bg-black/60 border border-blue-500/20 rounded-2xl p-8 flex flex-col justify-between shadow-lg hover:shadow-blue-500/30 transition-all duration-300 animate-fade-in-up animation-delay-200">
          <h3 className="text-xl font-semibold text-white mb-6" style={{fontFamily: 'Copperplate Gothic Bold, serif'}}>Behind the Scenes: The Command-Line Magic Powering Your Favorite Linux GUI Programs</h3>
        ...
        {/* Blog 3 */}
        <div className="flex-1 bg-black/60 border border-blue-500/20 rounded-2xl p-8 flex flex-col justify-between shadow-lg hover:shadow-blue-500/30 transition-all duration-300 animate-fade-in-up animation-delay-400">
          <h3 className="text-xl font-semibold text-white mb-6" style={{fontFamily: 'Copperplate Gothic Bold, serif'}}>How to Customize Linux Application Icons: Make Your Desktop Truly Yours</h3>
